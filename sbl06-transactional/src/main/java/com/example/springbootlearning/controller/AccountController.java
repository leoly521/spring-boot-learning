...
public class AccountController {
    ...
    @RequestMapping(value = "transfer/{fromId}/{toId}/{amount}", method = RequestMethod.POST)
    public boolean transfer(@PathVariable(value = "fromId") int fromId, @PathVariable(value = "toId") int toId, @PathVariable(value = "amount") double amount, @RequestParam(value = "throwException", required = false, defaultValue = "false") boolean throwException) {
        return this.accountService.transfer(fromId, toId, amount, throwException);
    }
}
